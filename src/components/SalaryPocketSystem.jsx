...
export const DeferredPaymentsPanel = ({
  ...
  const totalPendingAmount = deferred.reduce((sum, t) => sum + (Number(t.amount) || 0), 0);
  ...
  return (
    <div className="rounded-2xl border border-amber-500/30 bg-amber-500/5 shadow-sm overflow-hidden">
      ...
      <button
        ...
        className="w-full flex items-center justify-between p-4 bg-amber-500/10 hover:bg-amber-500/15 transition-colors text-left"
      >
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <p className="font-bold text-sm text-foreground">⏳ Pending Payments (கொடுக்க வேண்டியவை)</p>
